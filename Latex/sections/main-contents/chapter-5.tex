...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         \hline
         \rowcolor{cyan}\multicolumn{5}{|c|}{\textbf{Đánh giá trên bộ dữ liệu BIDV}}\\
         \hline
         \centering Model & Training:Testing & RMSE & MAE & MAPE (\%)\\
         \hline
         \multirow{2}{*}{\makecell{Linear\\Regression}\Gape[4pt]} & 7:3 & 7545.22&6125.68&13.75 \\ & 8:2 & 7336.11&5831.44&12.41 \\ & \textbf{9:1} & \textbf{8937.58} & \textbf{7874.29} & \textbf{15.81}\\
         \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{\makecell{Kalman\\Filter}\Gape[4pt]} & 7:3 & 347.07&183.11& 0.46\\ & 8:2 & 808.84&224.45&0.57 \\ & \textbf{9:1} & \textbf{1023.80} & \textbf{304.91} & \textbf{0.78}\\
         \hline
         \multirow{2}{*}{\makecell{Meta\\Learning}\Gape[4pt]} & 7:3 & 6687.32&4953.23&11.22\\ & 8:2 & 8905.57&7149.11&115.72 \\ & \textbf{9:1} & \textbf{11619.81} & \textbf{10248.67} & \textbf{20.89}\\
         \hline
         \multirow{2}{*}{NBeats} & 7:3 & 1568.92&1225.05&3.02\\ & 8:2 & 1333.41&993.17&2.29 \\ & \textbf{9:1} & \textbf{1452.04} & \textbf{1122.96} & \textbf{2.31}\\
         \hline
         \multirow{2}{*}{N-HiTS} & 7:3 & 7651.12&5947.20&14.20\\ & 8:2 & 7456.19&5940.45&13.56 \\ & \textbf{9:1} & \textbf{5998.81} & \textbf{4663.71} & \textbf{10.02}\\
         \hline
    \end{tabular}
    \label{bidvresult_2}
\end{table}
...
% VCB table
\subsubsection{Đánh giá mô hình trên bộ dữ liệu Vietcombank (VCB)}
\begin{table}[H]
    \centering
    \caption{Đánh giá trên bộ dữ liệu VCB cho 5 thuật toán đầu}
    \begin{tabular}{|c|c|c|c|c|}
         \hline
         \rowcolor{cyan}\multicolumn{5}{|c|}{\textbf{Đánh giá trên bộ dữ liệu VCB}}\\
         \hline
         \centering Model & Training:Testing & RMSE & MAE & MAPE (\%)\\
         \hline
         \multirow{2}{*}{\makecell{Linear\\Regression}\Gape[4pt]} & 7:3 & 9193.28&8187.25&9.7 \\ & 8:2 & 10964.97&10382.15&11.63 \\ & \textbf{9:1} & \textbf{7267.68} & \textbf{6470.07} & \textbf{7.03}\\
         \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{\makecell{Kalman\\Filter}\Gape[4pt]} & 7:3 & 719.21&317.71&0.42\\ & 8:2 & 1639.78&396.68&0.53 \\ & \textbf{9:1} & \textbf{3006.35} & \textbf{602.69} & \textbf{0.85}\\
         \hline
         \multirow{2}{*}{\makecell{Meta\\Learning}\Gape[4pt]} & 7:3 & 17732.50&15385.31&17.92\\ & 8:2 & 24116.94&22014.26&24.83 \\ & \textbf{9:1} & \textbf{24780.37} & \textbf{22537.83} & \textbf{24.92}\\
         \hline
         \multirow{2}{*}{NBeats} & 7:3 & 2489.45&1960.15&2.45\\ & 8:2 & 1903.88&1444.53&1.64 \\ & \textbf{9:1} & \textbf{1565.97} & \textbf{1121.88} & \textbf{1.24}\\
         \hline
         \multirow{2}{*}{N-HiTS} & 7:3 & 12162.19&9543.26&11.93\\ & 8:2 & 5954.34&4727.45&5.39 \\ & \textbf{9:1} & \textbf{5902.18} & \textbf{4658.74} & \textbf{5.23}\\
         \hline
    \end{tabular}
    \label{vcbresult_2}
\end{table}
...
% EIB table
\subsubsection{Đánh giá mô hình trên bộ dữ liệu Eximbank (EIB)}
\begin{table}[H]
    \centering
    \caption{Đánh giá trên bộ dữ liệu EIB cho 5 thuật toán đầu}
    \begin{tabular}{|c|c|c|c|c|}
         \hline
         \rowcolor{cyan}\multicolumn{5}{|c|}{\textbf{Đánh giá trên bộ dữ liệu EIB}}\\
         \hline
         \centering Model & Training:Testing & RMSE & MAE & MAPE (\%)\\
         \hline
         \multirow{2}{*}{\makecell{Linear\\Regression}\Gape[4pt]} & 7:3 & 8518.18&8267.90&46.95 \\ & 8:2 & 5503.29&5322.43&29.54 \\ & \textbf{9:1} & \textbf{3966.94} & \textbf{3875.98} & \textbf{21.20}\\
         \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{\makecell{Kalman\\Filter}\Gape[4pt]} & 7:3 & 593.36&179.24&0.98\\ & 8:2 & 230.39&117.18&0.66 \\ & \textbf{9:1} & \textbf{415.36} & \textbf{135.54} & \textbf{0.79}\\
         \hline
         \multirow{2}{*}{\makecell{Meta\\Learning}\Gape[4pt]} & 7:3 & 4699.01&3753.18&21.28\\ & 8:2 & 2554.86&2115.52&11.81 \\ & \textbf{9:1} & \textbf{2573.81} & \textbf{2034.43} & \textbf{11.12}\\
         \hline
         \multirow{2}{*}{NBeats} & 7:3 & 1923.79&1151.80&6.84\\ & 8:2 & 556.92&414.03&2.22 \\ & \textbf{9:1} & \textbf{467.71} & \textbf{353.59} & \textbf{1.91}\\
         \hline
         \multirow{2}{*}{N-HiTS} & 7:3 & 2364.13&1824.13&10.32\\ & 8:2 & 1736.39&1321.19&7.09 \\ & \textbf{9:1} & \textbf{915.90} & \textbf{717.02} & \textbf{3.89}\\
         \hline
    \end{tabular}
    \label{eibresult_2}
\end{table}
...
\subsection{Dự đoán giá cho 90 ngày tới của 3 mô hình tốt nhất} 
% \subsubsection{Linear Regression}
% \begin{figure}[H]
%     \centering
%     % BIDV
...
%     \caption{Dự đoán 90 ngày tới của mô hình LSTM}
