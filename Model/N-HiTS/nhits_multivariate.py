...
from src.losses.numpy import mae, mse, rmse
...
def main(args):
    ...
    if not os.path.isfile(hyperopt_file):
        ...
        trials = hyperopt_tunning(space=space, hyperopt_max_evals=args.hyperopt_max_evals, loss_function_val=mae,
                                  loss_functions_test={'mae':mae, 'mse': mse, 'rmse': rmse},
...
def parse_args():
    ...
    parser.add_argument('--test_ratio', default=None, required=False, type=float, help='test ratio')
